...
part 'source/api/animation/Animation.dart';
part 'source/api/animation/AnimationManager.dart';
part 'source/api/animation/Frame.dart';
part 'source/api/animation/SpriteAnimable.dart';
part 'source/api/animation/MovementSpeed.dart';

part 'source/api/character/Controllable.dart';
part 'source/api/character/CharacterGroundState.dart';
part 'source/api/character/CharacterShootState.dart';
part 'source/api/character/CharacterDamageState.dart';

part 'source/api/sprite/BackgroundColor.dart';
part 'source/api/sprite/SpriteDirectionState.dart';
part 'source/api/sprite/Collidable.dart';

part 'source/api/character/CharacterState.dart';
part 'source/api/character/Character.dart';

part 'source/api/stage/MapSprite.dart';
part 'source/api/stage/StageArea.dart';
part 'source/api/stage/BossStage.dart';
part 'source/api/stage/Camera.dart';
part 'source/api/stage/SceneManager.dart';

part 'source/api/weapon/Weapon.dart';
part 'source/api/weapon/projectile/Projectile.dart';

part 'source/domain/character/Megaman.dart';

part 'source/domain/stage/TopManMap.dart';

part 'source/domain/weapon/LemonBuster.dart';
part 'source/domain/weapon/projectile/LemonBusterProjectile.dart';
...
void main() {
    ...
    BitmapData.defaultLoadOptions.webp = false;
    BitmapData.load("images/Loading.png").then((bitmapData) {
        ...
        loadingTextField.x = Game.CANVAS_WIDTH / 2 - loadingTextField.textWidth / 2;
        loadingTextField.y = Game.CANVAS_HEIGHT / 2 - loadingTextField.textHeight / 2;
...
void loadResources() {
    ...
    resourceManager.addTextureAtlas("Weapon", "images/WeaponTextureAtlas.json", TextureAtlasFormat.JSONARRAY);

    resourceManager.addTextureAtlas("Item", "images/ItemTextureAtlas.json", TextureAtlasFormat.JSONARRAY);

    resourceManager.addTextureAtlas("Megaman", "images/MegaManTextureAtlas.json", TextureAtlasFormat.JSONARRAY);
    resourceManager.addTextureAtlas("TopManMap", "images/maps/TopManMapTextureAtlas.json", TextureAtlasFormat.JSONARRAY);
    ...
    resourceManager.load().then((res) {
        ...
        stage.addChild(game);
        html.document.onKeyDown.listen((event) => game._onKeyDown(event));
        html.document.onKeyUp.listen((event) => game._onKeyUp(event));
        game.start();
